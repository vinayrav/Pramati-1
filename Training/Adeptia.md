...
-   ** **Adeptia ETL Suite (AES) is a graphical, easy-to-use data
    mapping solution that is ideal for aggregating data from multiple
    sources to populate databases and data warehouses for Business
...
-   **Shared Connections:**Companies publish a Shared Connection, which
    ...
    simplifies and reduces the effort needed to create, manage and
    add connections.
